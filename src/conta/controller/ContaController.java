...
public class ContaController implements ContaRepository {
	...
	public void procurarPorNumero(int numero) {
		...
		if (conta != null)
			...
			System.out.println(
					Cores.TEXT_RED_BOLD + "\nConta número: " + numero + " não foi encontrada!" + Cores.TEXT_RESET);
	...
	public void deletar(int numero) {
		...
		if (conta != null) {
			...
			System.out.println(
					Cores.TEXT_RED_BOLD + "\nA Conta numero " + numero + " não foi encontrada!" + Cores.TEXT_RESET);
	}
	...
	// Método Auxiliar para gerar o número da conta
	public int gerarNumero() {
		return ++numero;
	}

	// Método Auxiliar para Procurar por número
